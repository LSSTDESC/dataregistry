...
parser = argparse.ArgumentParser(
    description="Creates dataregistry tables for specified schema and connection information (config). For postgresql database, normally run from reg_admin account",
